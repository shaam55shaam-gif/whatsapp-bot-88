...
app = Flask(__name__)
LEAGUES={"السعودي - روشن":4335,"الانجليزي":4328,"الاسباني":4332,"ابطال اوروبا":4480,"التركي":4331}
def get_live(lid):
 try:
  ...
  if ev:
   out=[]
   for e in ev:
    out.append({"t1":e["strHomeTeam"],"t2":e["strAwayTeam"],"time":(e["strTime"] or "20:00")[:5],"league":e["strLeague"]})
   return out
 except: pass
 return None
